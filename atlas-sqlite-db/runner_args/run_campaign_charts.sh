...
ARGS_DIR="$PROJECT_ROOT/atlas-sqlite-db/input_args"
OUTPUT_DIR="$PROJECT_ROOT/atlas-sqlite-db/output_target"
DB_PATH="/home/alex/dbt_ads/atlas/atlas-sqlite-db/db/ads.db"
